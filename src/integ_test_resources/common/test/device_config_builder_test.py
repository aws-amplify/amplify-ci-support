        ...
        self.assertEqual(
            {
                'apigateway': {
                    ...
                    'endpoint_us_east_1': 'https://redactedapi.execute-api.us-east-1.amazonaws.com/prod/',
                    'endpoint_us_east_2': 'https://redactedapi.execute-api.us-east-2.amazonaws.com/prod',
                },
                'core': {
                    'identity_pool_id': 'us-east-1:00000000-3c37-43d7-8fe6-3e0a65985b02'
                }
            },
            package_data
        )
